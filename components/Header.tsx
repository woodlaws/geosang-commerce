...
const links = [["캠페인", "/campaigns"], ["브랜드 입점", "/brands"], ["인플루언서 지원", "/creators"], ["진행 방법", "/process"], ["성공사례", "/cases"], ["회사 소개", "/about"]];
  ...
  return <>
    ...
    <header className="site-header-wrap">
      <div className="site-header">
        <Link href="/" className="brand-mark" onClick={() => setOpen(false)}><strong>GEOSANG</strong><span>CREATOR COMMERCE</span></Link>
