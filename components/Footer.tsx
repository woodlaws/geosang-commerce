...
export function Footer() {
  ...
  return <footer className="footer"><div className="shell footer-grid">
    <div className="footer-brand"><BrandLogo /><p>좋은 상품과 영향력 있는 크리에이터가 만나는 공동구매 플랫폼</p><small>{siteConfig.operatorNotice}</small><b>CREATORS · BRANDS · COMMERCE CONNECTION</b></div>
    <div><strong>서비스</strong><Link href="/campaigns">공동구매 캠페인</Link><Link href="/brands">브랜드 입점 문의</Link><Link href="/creators">크리에이터 지원</Link></div>
