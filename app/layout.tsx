...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      <body><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} /><Header />{children}<Footer /><div className="mobile-bottom-cta"><a href="/brands#inquiry">입점 문의</a><a href="/creators#apply">인플루언서 지원</a></div></body>
    </html>
  );
}
