export const siteConfig = {
  name: "GEOSANG CREATOR COMMERCE",
  description: "브랜드와 인플루언서를 연결해 공동구매 캠페인을 기획하고 운영하는 거상마케팅센터의 크리에이터 커머스 플랫폼",
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://geosang-creator.com",
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "정보 입력 필요",
  phone: process.env.NEXT_PUBLIC_CONTACT_PHONE || "정보 입력 필요",
...
export const commonFaqs = [
  ...
  { question: "브랜드는 어떤 업무를 맡게 되나요?", answer: "상품 정보와 재고를 제공하고 주문 상품을 출고합니다. 거상마케팅센터는 크리에이터 매칭, 일정 조율, 운영과 정산 중계를 지원합니다." },
];
