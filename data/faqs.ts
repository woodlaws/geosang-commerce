...
export const faqItems: FAQItem[] = [
  ...
  { id: "brand-eligibility", category: "brand", question: "어떤 상품이 입점할 수 있나요?", answer: "정상적으로 판매할 수 있고 안정적인 공급과 소비자 배송이 가능하며, 정확한 상품 정보와 판매 조건을 제공할 수 있는 상품을 검토합니다. 식품, 건강식품, 뷰티, 생활용품 등 카테고리와 무관하게 상품 경쟁력과 콘텐츠 적합성을 함께 확인합니다." },
  ...
  { id: "brand-creator-choice", category: "brand", question: "인플루언서는 어떻게 선정하나요?", answer: "거상커머스가 상품 카테고리, 예상 고객층과 콘텐츠 적합성을 바탕으로 인플루언서 후보를 검토해 제안합니다. 브랜드와 조건과 일정을 협의한 뒤 최종 진행 대상을 정하며, 특정 인플루언서 요청은 섭외 가능 여부를 별도로 확인합니다." },
  { id: "brand-fulfillment", category: "brand", question: "브랜드가 직접 배송해야 하나요?", answer: "기본적으로 상품을 보유한 브랜드 또는 공급사가 주문 확인과 소비자 배송을 담당합니다. 자체 배송이 어려운 경우에는 위탁배송 가능 여부와 필요한 운영 조건을 상담 단계에서 협의합니다." },
  { id: "brand-samples", category: "brand", question: "제품 샘플은 몇 개가 필요한가요?", answer: "필요한 샘플 수량은 검토할 인플루언서 수, 콘텐츠 형식과 캠페인 일정에 따라 달라집니다. 상품 제안 단계에서는 제공 가능 여부만 알려 주시고, 실제 수량과 배송 일정은 진행 후보가 정해진 뒤 협의합니다." },
